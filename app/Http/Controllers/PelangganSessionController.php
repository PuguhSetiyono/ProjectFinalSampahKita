...
// File: app/Http/Controllers/PelangganSessionController.php
...
use App\Http\Requests\PelangganLoginRequest; // Ganti jalur ke PelangganLoginRequest

class PelangganSessionController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('pelanggan')->attempt($credentials)) {
            return redirect()->intended('/frontend/home'); // Redirect to intended page after login
        }
