...
@include('layouts.sidebar')
      ...
      <div class="flex-grow">
        ...
        <div class="p-4">
          <ul class="space-y-1">
            ...
            <li>
              <a href="{{ route('admin.pelanggan') }}" class="flex items-center bg-green-200 rounded-xl font-bold text-sm text-green-900 py-3 px-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="text-lg mr-4" viewBox="0 0 16 16">
 ...
 <!-- resources/views/backend/pelanggan/index.blade.php -->

<main class="ml-60 pt-16 max-h-screen overflow-auto">
  <div class="px-6 py-8">
      <div class="max-w-7xl mx-auto">
          <div class="bg-white rounded-3xl px-8 py-5 mb-5">
              <h1 class="text-3xl font-bold mb-3">Data Pelanggan</h1>
                  ...
                  <table class="min-w-full bg-white border border-gray-300">
                      <thead>
                          <tr>
                              ...
                              <th class="py-2 px-4 border-b">Id_Users</th>
                      ...
                      <tbody>
                          @foreach($pelanggans as $pelanggan)
                              <tr>
                                  ...
                                  <td class="py-2 px-4 border-b">{{ $pelanggan->alamat_pl }}</td>
                                  <td class="py-2 px-4 border-b">{{ $pelanggan->tlp_pl }}</td>
                                  <td class="py-2 px-4 border-b">{{ $pelanggan->id_users }}</td>
                                  <td class="py-2 px-4 border-b">{{ $pelanggan->latitude }}</td>
                                  <td class="py-2 px-4 border-b">{{ $pelanggan->longitude }}</td>
                                  <td class="py-2 px-4 border-b">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('admin.pelanggan.edit', $pelanggan->id) }}" class="bg-yellow-500 text-white px-3 py-1 rounded-md hover:bg-blue-600">Edit</a>
