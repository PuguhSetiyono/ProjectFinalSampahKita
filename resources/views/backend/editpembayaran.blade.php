    ...
    <div class="px-6 py-8">
        <div class="max-w-7xl mx-auto">
            <div class="bg-white rounded-3xl px-8 py-5 mb-5">
                <h1 class="text-3xl font-bold mb-3">Edit Pembayaran</h1>
                <hr class="mt-1">
                        ...
                        <form action="{{ route('admin.pembayaran.update', $pembayaran->id) }}" method="POST">
                            ...
                            @method('PUT')
                                ...
                                <div class="col-span-2">
                                    <label for="status_pembayaran" class="block font-semibold">Status Pembayaran</label>
                                    <input type="text" id="status_pembayaran" name="status_pembayaran" value="{{ $pembayaran->status_pembayaran }}" class="border border-gray-300 rounded-md px-3 py-2 w-full">
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <!-- Tambahkan tombol batal jika diperlukan -->
                            </div>
                        </form>
                    </div>
                </div>
