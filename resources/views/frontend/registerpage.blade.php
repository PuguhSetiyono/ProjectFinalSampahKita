...
<section class="bg-white">
  <div class="container mx-auto my-12">
    ...
    <div class="text-center mb-8">
      <h2 class="text-3xl font-semibold">Lengkapi Data Diri</h2>
      <p>Silakan lengkapi formulir di bawah untuk dapat melakukan pemesanan.</p>
    </div>
    ...
    <div class=" flex items-center justify-center">
      ...
      <form action="{{ route('register-pl.store') }}" class=" w-1/2 space-y-4 text-sm" method="POST">
        ...
        <div>
          ...
          <input class="w-full rounded-lg border border-gray-200 p-3" placeholder="Name" type="text" name="nama" id="nama" value="{{ Auth::user()->name }}" readonly required />
        </div>

        <div>
          <label class="sr-only" for="nama">Phone</label>
          <input class="w-full rounded-lg border border-gray-200 p-3" placeholder="Phone Number" type="tel" name="tlp_pl" id="tlp_pl" required />
        </div>
        ...
        <div class="text-center">
          <button type="submit" class="block w-full text-center mb-3 rounded-lg border bg-green-800 p-3 text-white cursor-pointer hover:border-black">
            Simpan Profil
          </button>
